    ...
    <div className={`text-white py-3 px-4 ${isMyspaceMode 
      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <span className="text-sm text-gray-100">a place to showcase my work</span>
        </div>
        <div className="flex items-center space-x-4">
          <input type="text" placeholder="Search projects..." className={`px-3 py-2 ${isMyspaceMode ? 'bg-pink-100 border-pink-300 focus:ring-pink-500' : 'bg-gray-50 border-gray-300 focus:ring-blue-500'} text-gray-900 border text-sm rounded-lg focus:outline-none focus:ring-2`} />
          ...
          <a href="#" className="text-sm hover:text-pink-200 transition-colors duration-200">Help</a>
          <button
