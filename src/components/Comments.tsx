  ...
  return (
    <div className="bg-white border-2 border-blue-500 p-4">
      <div className="flex items-center justify-between mb-3">
        <div>
          <h2 className="font-bold text-black text-sm">Recommendations</h2>
          <p className="text-xs text-gray-500 italic">Comments</p>
        </div>
        <span className="text-xs text-blue-600">({comments.length})</span>
      </div>
      
      <p className="text-xs text-black mb-4">Professional recommendations and feedback from colleagues.</p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-1">
                  <span className="text-xs font-bold text-black">{comment.name}</span>
                  <span className="text-xs text-gray-600 italic">• {comment.role}</span>
                </div>
                <p className="text-xs text-black leading-relaxed">{comment.comment}</p>
              </div>
            </div>
          </div>
        ))}
      ...
      <div className="border-t border-gray-300 pt-4">
        <h3 className="text-xs font-bold text-black mb-3">Leave a Recommendation</h3>
        <form onSubmit={handleSubmit} className="space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-2 py-1 text-xs border border-gray-300 focus:border-blue-500 focus:outline-none"
          ...
          <div>
            <label className="block text-xs text-black mb-1">Your Recommendation *</label>
            <textarea
              name="comment"
              ...
              required
              rows={3}
              className="w-full px-2 py-1 text-xs border border-gray-300 focus:border-blue-500 focus:outline-none resize-none"
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="myspace-button hover:bg-blue-600 transition-colors duration-200"
            >
              Post Comment
            </button>
          </div>
