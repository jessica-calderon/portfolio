...
const LearningWall: React.FC<LearningWallProps> = ({ isMyspaceMode, searchQuery }) => {
  ...
  const entries: LearningEntry[] = [
    {
      id: 1,
      timestamp: "08/31/2026 1:00 AM",
      learning: "Built Workers Room — a Silicon Valley themed homelab dashboard for managing Cursor CLI subagents. Pied Piper inspired UI with character-named worker slots, server closet monitoring, Tunarr broadcast controls, and a Blockbuster-style media shelf. Because infrastructure deserves personality.",
      focus: "Cursor CLI agents, homelab orchestration, themed UI/UX, and subagent workflows."
    },
    {
      id: 2,
